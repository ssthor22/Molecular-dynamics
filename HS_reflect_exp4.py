...
# Hard spheres initialized in simple cubic configuration

# LATEST WORKING REFLECTIVE CUBIC HS

#=================================================================================
# Exp 4: Scan across phi = [0.1,0.3,0.49,0.5], L = [14*r, 9.7*r, 8.15*r, 8.1*r]
#=================================================================================
...
#	raw_input()
	...
	f = open('log.log','wb')
	steps = 20000
	L_values = [14*r, 9.7*r, 8.15*r, 8.1*r]
